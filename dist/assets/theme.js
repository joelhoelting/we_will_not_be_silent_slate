...
slate.Variants = (function() {
  ...
  function Variants(options) {
    ...
    this.product = options.product; //JSON of product we have built
    this.singleOptionSelector = options.singleOptionSelector; // data-single-option
...
theme.Product = (function() {
  ...
  var selectors = {
    ...
    originalSelectorId: '[data-product-select]', // single field full config of a product
    priceWrapper: '[data-price-wrapper]',
    productFeaturedImage: '[data-product-featured-image]',
    productJson: '[data-product-json]',
    productPrice: '[data-product-price]',
    productThumbs: '[data-product-single-thumbnail]',
    singleOptionSelector: '[data-single-option-selector]' // single option of a product
  };
